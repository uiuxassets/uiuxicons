...
export const IconCircle = /*#__PURE__*/ createIcon("circle", {
    ...
    duotone: {
      light: <><path fill="var(--uiux-accent, currentColor)" fillOpacity="0.25" d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0"/><path fill="currentColor" d="M20.5 12a8.5 8.5 0 1 0-17 0 8.5 8.5 0 0 0 17 0m1 0a9.5 9.5 0 1 1-19 0 9.5 9.5 0 0 1 19 0"/></>,
      regular: <><path fill="var(--uiux-accent, currentColor)" fillOpacity="0.25" d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0"/><path fill="currentColor" d="M20.25 12a8.25 8.25 0 1 0-16.5 0 8.25 8.25 0 0 0 16.5 0m1.5 0c0 5.385-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12 6.615 2.25 12 2.25s9.75 4.365 9.75 9.75"/></>,
      bold: <><path fill="var(--uiux-accent, currentColor)" fillOpacity="0.25" d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0"/><path fill="currentColor" d="M20 12a8 8 0 1 0-16 0 8 8 0 0 0 16 0m2 0c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10"/></>,
    },
    solid: {
