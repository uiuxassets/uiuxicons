...
export const CATEGORY_PATTERNS = [
  ...
  [/^(grid|list|table|columns?|rows?|panel|layout|padding|margin|spacing)/, 'layout'],
...
export const TOKEN_SYNONYMS = {
  ...
  grid: ['layout', 'cells', 'gallery', 'dashboard', 'apps', 'tiles'],
  columns: ['column', 'layout', 'vertical', 'split'],
  rows: ['row', 'layout', 'horizontal', 'stack'],
  padding: ['spacing', 'space', 'margin', 'inset', 'layout'],
  horizontal: ['x'],
  vertical: ['y'],
...
export const NAME_EXTRAS = {
  ...
  'clock-cw': ['redo'],
  'clock-ccw': ['undo'],
  'arrow-cw': ['reload', 'refresh', 'update', 'repeat'],
  'arrow-ccw': ['reset', 'restore', 'revert', 'refresh'],
  'arrows-cw': ['refresh', 'reload', 'sync', 'update', 'repeat', 'spinner', 'loading'],
  'arrows-ccw': ['refresh', 'sync', 'restore', 'revert'],
  ...
  'search-plus': ['zoom-in', 'enlarge', 'magnify'],
  'search-minus': ['zoom-out', 'reduce', 'shrink'],
